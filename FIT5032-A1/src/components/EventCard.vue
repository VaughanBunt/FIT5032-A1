  ...
  >
    <div class="row g-0 align-items-center m-2">
      ...
      <div class="col-md-8 d-flex flex-column justify-content-between">
        ...
        <div
          class="card-footer bg-transparent border-top-0 d-flex justify-content-end"
          @click.stop
        >
          <StarRating :rating="avgRating" class="me-auto" />
          <div v-if="!isAdmin">
            <button class="btn btn-secondary" disabled @click.stop.prevent v-if="!loggedIn">
              Log in to Apply
            </button>
            ...
            <button class="btn btn-primary" @click.stop.prevent="applyToEvent" v-else-if="!alreadyApplied">
              Apply
            </button>
